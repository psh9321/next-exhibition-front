...
import { API_SERVER_MEETING_ATTEND } from "@/api/meeting.server";
...
export async function POST(req : NextRequest){
    try {
        ...
        const { resultCode, data, errMsg } = await API_SERVER_MEETING_ATTEND(token, _id) as  MEETING_PROMISE_RESPONSE;
