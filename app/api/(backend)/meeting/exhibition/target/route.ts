...
import { API_SERVER_MEETING_EXHIBITION_TARGET } from "@/api/meeting.server";
...
export async function POST(req : NextRequest) {
    try {
        ...
        const { resultCode, data, errMsg } = await API_SERVER_MEETING_EXHIBITION_TARGET(seq) as MEETING_LIST_RESPONSE;
